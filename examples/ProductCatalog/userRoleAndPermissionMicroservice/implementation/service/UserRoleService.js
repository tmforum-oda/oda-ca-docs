...
exports.createUserRole = function(req, res, next) {
   ...
   *
   * userRole UserRole_Create The UserRole to be created
   * returns UserRole
   **/

  console.log('createUserRole :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument userRole */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createUserRole: error=" + error);
    ...
    .catch( error => {
      console.log("createUserRole: error=" + error.toString());
      sendError(res, error);
    });
...
exports.listUserRole = function(req, res, next) {
  ...
  console.log('listUserRole :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listUserRole: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchUserRole = function(req, res, next) {
   ...
   * userRole UserRole_Update The UserRole to be updated
   * returns UserRole
   **/

  console.log('patchUserRole :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchUserRole error=" + error);
...
exports.retrieveUserRole = function(req, res, next) {
  ...
  console.log('retrieveUserRole :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveUserRole: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {

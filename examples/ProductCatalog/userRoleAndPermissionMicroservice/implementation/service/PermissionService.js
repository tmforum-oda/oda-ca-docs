...
exports.createPermission = function(req, res, next) {
   ...
   *
   * permission Permission_Create The Permission to be created
   * returns Permission
   **/

  console.log('createPermission :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument permission */
  ...
  swaggerUtils.getPayload(req)
    ...
    .catch( error => {
      console.log("createPermission: error=" + error.toString());
      sendError(res, error);
    });
...
exports.listPermission = function(req, res, next) {
  ...
  console.log('listPermission :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listPermission: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.patchPermission = function(req, res, next) {
   ...
   * permission Permission_Update The Permission to be updated
   * returns Permission
   **/

  console.log('patchPermission :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
          ...
          db.collection(resourceType)
            ...
            .then(() => {
              db.collection(resourceType).findOne(query)
                ...
                .catch((error) => {
                  console.log("patchPermission error=" + error);
...
exports.retrievePermission = function(req, res, next) {
  ...
  console.log('retrievePermission :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrievePermission: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {

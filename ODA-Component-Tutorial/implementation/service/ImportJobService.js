...
exports.createImportJob = function(req, res, next) {
   ...
   *
   * importJob ImportJob_Create The ImportJob to be created
   * returns ImportJob
   **/

  console.log('createImportJob :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);

  /* matching isRestfulCreate - argument importJob */
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      mongoUtils.connect().then(db => {
        db.collection(resourceType)
          ...
          .catch((error) => {
            console.log("createImportJob: error=" + error);
    ...
    .catch( error => {
      console.log("createImportJob: error=" + error.toString());
      sendError(res, error);
    });
...
exports.deleteImportJob = function(req, res, next) {
  ...
  console.log('deleteImportJob :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
...
exports.listImportJob = function(req, res, next) {
  ...
  console.log('listImportJob :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  .then(db => {
    ...
    .then(stats => {
      ...
      .catch(error => {
        console.log("listImportJob: error=" + error);
        sendError(res, internalError);
      })
    })
    .catch(error => {
...
exports.retrieveImportJob = function(req, res, next) {
  ...
  console.log('retrieveImportJob :: ' + req.method + ' ' + req.url + ' ' + req.headers.host);
  ...
  mongoUtils.connect().then(db => {
    db.collection(resourceType)
      ...
      .catch(error => {
        console.log("retrieveImportJob: error=" + error);
        sendError(res, internalError);
      });
  })
  .catch(error => {
